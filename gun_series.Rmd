...
ggplot(gun_series)+
  ...
  geom_vline(xintercept=c(75), linetype="dotted", color="blue", size=1)+
  geom_vline(xintercept=c(65), linetype="dotted", color="orange", size=1)+
  theme_minimal()

ggplot(gun_series[gun_series$week_id<=80,])+
