...
ggplot(series)+
  ...
  geom_label(aes(x=series$begin_date[series$year==2020 & series$weekofyr==isoweek(date("2020-05-25"))],
                 y=0.050), 
             label = "George Floyd", show.legend = FALSE)+
  labs(title = "Figure 1: Weekly Firearm Unintentional Injuries, 2016-2020",
       subtitle = "MHA Hospital Data",
       x = "Week",
       y = "Rate per 1,000 Residents")+
  theme_minimal()+
...
ggplot(series)+
  ...
  geom_label(aes(x=series$begin_date[series$year==2020 & series$weekofyr==isoweek(date("2020-05-25"))],
                 y=0.050), 
             label = "George Floyd", show.legend = FALSE)+
  labs(title = "Figure 1: Weekly Firearm Suicide Injuries, 2016-2020",
       subtitle = "MHA Hospital Data",
       x = "Week",
       y = "Rate per 1,000 Residents")+
  theme_minimal()+
...
ggplot(series)+
  ...
  geom_label(aes(x=series$begin_date[series$year==2020 & series$weekofyr==isoweek(date("2020-05-25"))],
                 y=0.050), 
             label = "George Floyd", show.legend = FALSE)+
  labs(title = "Figure 1: Weekly Firearm Undetermined Injuries, 2016-2020",
       subtitle = "MHA Hospital Data",
       x = "Week",
       y = "Rate per 1,000 Residents")+
  theme_minimal()+
...
ggplot(series)+
  ...
  geom_label(aes(x=series$begin_date[series$year==2020 & series$weekofyr==isoweek(date("2020-05-25"))],
                 y=0.050), 
             label = "George Floyd", show.legend = FALSE)+
  labs(title = "Figure 1: Weekly Firearm Legal Injuries, 2016-2020",
       subtitle = "MHA Hospital Data",
       x = "Week",
       y = "Rate per 1,000 Residents")+
  theme_minimal()+
