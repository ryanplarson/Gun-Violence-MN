...
cj_exp_prepost <- as(cj_exp_prepost, "Spatial")


nb <- poly2nb(cj_exp_prepost, queen = T)
summary(nb)
...
slmtest(, 
        data=cj_exp_prepost, listw = w, 
        test="lml",
        model="random")

lag <- spml(car_jack_rate~t+post_floyd+post_floyd_3+
             age_19_29_perc+age_30_49_perc+age_50_69_perc+
             age_70_plus_perc, 
                      data = cj_exp_prepost, 
             index = c("GEOID", "week"), effect="individual", model="random",
