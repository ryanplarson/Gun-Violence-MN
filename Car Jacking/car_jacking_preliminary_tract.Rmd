...
ggplot(cj_exp_week)+
  geom_line(aes(x=t, y=car_jack_rate))+
...
ggplot(homicide_week)+
  geom_line(aes(x=t, y=homicide_rate))+
  geom_vline(aes(xintercept = 180))
```
...
# random effects poisson - carjacking

rep <- glmer(car_jack~t+post_floyd+post_floyd_3+conc_dis+
             age_19_29_perc+age_30_49_perc+age_50_69_perc+
...
#renb <- glmer.nb(car_jack~t+post_floyd+post_floyd_3+conc_dis+
 #            age_19_29_perc+age_30_49_perc+age_50_69_perc+
  #           age_70_plus_perc+ post_floyd:conc_dis+post_floyd_3:conc_dis+
   #          (1|GEOID), 
    #      data = cj_exp_prepost)
...
sem <- spml(car_jack_rate~t+post_floyd+t_post_floyd+
             conc_dis+
             age_19_29_perc+age_30_49_perc+age_50_69_perc+
             age_70_plus_perc+ post_floyd:conc_dis+t_post_floyd:conc_dis, 
                      data = cj_exp_prepost, 
...
sarar <- spml(car_jack_rate~t+post_floyd+t_post_floyd+
             conc_dis+
             age_19_29_perc+age_30_49_perc+age_50_69_perc+
             age_70_plus_perc+ post_floyd:conc_dis+t_post_floyd:conc_dis, 
                      data = cj_exp_prepost, 
