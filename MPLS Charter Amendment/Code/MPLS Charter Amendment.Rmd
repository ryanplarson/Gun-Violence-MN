...
# is race missingness random across other observable (severity)
  # pre-post murder missingness change?
...
disagg_unemp <- estimate_down(wts = precinct_sf$total_pop, value = mpls_tract$unemp_rate, group = matches)
