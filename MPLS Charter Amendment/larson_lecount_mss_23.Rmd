...
- What relates to support for CA2?
  - political divides?
...
prez <- readxl::read_xlsx("MPLS Charter Amendment/Data/2020-general-federal-state-results-by-precinct-official.xlsx",
  ...
  mutate(pct_dem = USPRSDFL/TOTVOTING*100)
```
...
```{r, include = FALSE}
#dissatisfaction with overpolicing and underpolicing
#legal cynicism: concern with what's coming next
  # low turnout relative to district normally (relative to off-year previous)

#previous 2020 vote patterns in presidential election

#assumption: views on police seen primarily through race political ideology, not necessarily the case
  # crime conditions and policing matter

# the people most freed-up to be partisan are white liberals
  # easy for this group to slip into entirely ideological lens
```
